...
HD_PWD='C:/Users/maxgr/Documents/ECE3300L/LectureNotes/CounterParallel/CounterParallel.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ModuloCounter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ModuloCounter.tcl
